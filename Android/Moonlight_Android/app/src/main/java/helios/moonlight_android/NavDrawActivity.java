...
public class NavDrawActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nav_draw2);
...
//                .commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.lost_bike) {
            Intent intent = new Intent(this, LostBikeActivity.class);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((NavDrawActivity) activity).onSectionAttached(
